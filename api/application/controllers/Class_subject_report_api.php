...
/**
 * Class Subject Report API Controller
 * 
 * Provides API endpoints for retrieving class subject assignment information
 ...
 * @version    1.0.0
 */
class Class_subject_report_api extends CI_Controller
{
    /**
     * Constructor
     *
    ...
    public function __construct()
    {
        ...
        // Load required models - IMPORTANT: Load setting_model BEFORE subjecttimetable_model
    ...
    /**
     * Filter Class Subject Report
     * 
     * Retrieves class subject assignments based on optional filter parameters.
     ...
     * 
     * @method POST
     * @route  /api/class-subject-report/filter
     * 
    ...
    public function filter()
    {
        try {
            ...
            // Get class subject report data from model
            $data = $this->subjecttimetable_model->getClassSubjectReportByFilters($class_id, $section_id, $session_id);
            ...
            log_message('error', 'Class Subject Report API Filter Error: ' . $e->getMessage());
     ...
     * 
     * Retrieves all class subject assignments for the current session.
     * No filter parameters required - returns all subject assignments.
     * 
     * @method POST
     * @route  /api/class-subject-report/list
     * 
    ...
    public function list()
    {
        try {
            ...
            // Get all class subject assignments for current session (no filters)
            $data = $this->subjecttimetable_model->getClassSubjectReportByFilters(null, null, $session_id);
            ...
            log_message('error', 'Class Subject Report API List Error: ' . $e->getMessage());
