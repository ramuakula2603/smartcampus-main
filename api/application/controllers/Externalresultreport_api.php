...
class Externalresultreport_api extends CI_Controller
{
    ...
    /**
     * Get external result report based on filters
     * 
     * @return void Outputs JSON response with report data
     */
    public function get_external_result_report()
    {
        ...
        if ($method != 'POST') {
            ...
            if ($this->validate_headers()) {
                ...
                // Get report data
                $report_data = $this->externalresult_model->getExternalResultsReport($filters);
    ...
    public function get_filter_options()
    {
        ...
        if ($method != 'GET') {
            ...
            if ($this->validate_headers()) {
                ...
                // Get sessions
                $data['sessions'] = $this->externalresult_model->getSessionsWithResults();
                
                // Get exam types (external result types)
                $data['exam_types'] = $this->externalresult_model->getExamTypes();
