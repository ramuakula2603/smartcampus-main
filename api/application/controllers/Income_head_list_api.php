...
/**
 * Income Head List API Controller
 * 
 * This controller provides API endpoint for retrieving all income head records.
 * It handles listing operations for income head management.
 * 
 ...
 * @version    1.0.0
 */
class Income_head_list_api extends CI_Controller
{
    /**
     * Constructor
     * 
    ...
    public function list()
    {
        try {
            ...
            log_message('error', 'Income Head List API Error: ' . $e->getMessage());
