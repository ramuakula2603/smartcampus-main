...
/**
 * Student Profile Report API Controller
 * 
 * Provides API endpoints for retrieving comprehensive student profile information
 ...
 * @version    1.0.0
 */
class Student_profile_report_api extends CI_Controller
{
    /**
     * Constructor
     * 
    ...
    /**
     * Filter Student Profile Report
     * 
     * Retrieves comprehensive student profile data based on optional filter parameters.
     ...
     * 
     * @method POST
     * @route  /api/student-profile-report/filter
     * 
    ...
    public function filter()
    {
        try {
            ...
            // Get student profile report data from model
            $data = $this->student_model->getStudentProfileReportByFilters($class_id, $section_id, $session_id);
            ...
            log_message('error', 'Student Profile Report API Filter Error: ' . $e->getMessage());
     ...
     * 
     * Retrieves all student profile data for the current session.
     * No filter parameters required - returns all active students with comprehensive profile information.
     * 
     * @method POST
     * @route  /api/student-profile-report/list
     * 
    ...
    public function list()
    {
        try {
            ...
            // Get all student profiles for current session (no filters)
            $data = $this->student_model->getStudentProfileReportByFilters(null, null, $session_id);
            ...
            log_message('error', 'Student Profile Report API List Error: ' . $e->getMessage());
