    ...
    public function dtstudentlist()
    {
        ...
        if (!empty($students->data)) {
            foreach ($students->data as $student_key => $student) {
                ...
                // Enhanced View Button with Eye Icon
                ...
                // Enhanced Edit Button with Pencil Icon
                if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                ...
                // Enhanced Collect Fees Button with Money Icon
                ...
                // DEBUG: Log to check for extra data
                error_log('Building row for student ID: ' . $student->id);
                error_log('Row array count before adding data: ' . count($row));
                ...
                // DEBUG: Log final row structure
                error_log('Row array count after adding all data: ' . count($row));
