                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <input type="radio" value="<?php echo $language->id ?>" class="change_active" data-settingid="<?php echo $setting->id ?>" name="is_active" <?php if ($language->id == $language->currency_id) {
                                                                                                                                                                                                    echo "checked";
                                                                                                                                                                                                }
                                                                                                                                                                                                ?>>
                                                <?php
