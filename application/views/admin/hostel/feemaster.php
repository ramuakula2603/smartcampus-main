...
<div class="content-wrapper">
    ...
    <section class="content"> 
        <div class="row">                 
            <div class="col-md-12">
                <div class="box box-primary" id="hostel">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('hostel_fees_master'); ?></h3>   
                    </div>
                    <form action="" id="fee_form" method="POST">
                        <div class="box-body feemaster">
                            ...
                            foreach ($month_list as $month_key => $month_value) {
                                ...
                                $record=multiKeyExists($hostelfees, 'month' ,$month_key);


                                if($record > -1){
                                $chk=true;
                                $inserted_array=$hostelfees[$record];
                            ...
                            <div class="row block_row">       
                                ...
                                <div class="col-sm-2 col-lg-2 col-md-2">         
                                    <h4 class="hostel_fee_line"><?php echo $month_value; ?></h4>
                                </div>
                        ...
                        <div class="box-footer">
                            <?php if ($this->rbac->hasPrivilege('hostel_fees_master', 'can_edit')) {  ?>
