                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            ...
                                                            foreach($resultdata as $res){
                                                                ...
                                                                $is_absent = (strtoupper(trim($res['actualmarks'])) === 'AB');
                                                                if ($is_absent) {
                                                                    $has_absent = true;
                                                                    $finalresultstatus = 0;
                                                                } else {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center">
                                                                <?php if ($is_absent) { ?>
                                                                    AB
                                                                <?php } else { ?>
                                                                    <?php echo getPercent($markdata['maxmarks'],$res['actualmarks']);?>%
                                                                <?php } ?>
                                                            </td>
                                                            <td style="text-align: center">
                                                                ...
                                                                <?php } elseif($markdata['minmarks']>$res['actualmarks']){
                                                                    $finalresultstatus=0;
                                                                ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            $exam_percentage = $has_absent ? 'AB' : getPercent($total_max_marks,$total_marks);
                                                        ?>
                                                        
                                                        <tr>
                                                            <td class="bolds"><?php echo $this->lang->line('total_marks'); ?> : <?php echo ($has_absent ? 'AB' : $total_marks) . "/" . $total_max_marks; ?></td>
                                                            <td class="bolds"><?php echo $this->lang->line('percentage'); ?> (%) : <?php echo $exam_percentage; ?></td>
                                                            <td class="bolds">
                                                                <?php echo $this->lang->line('result_status');?>
                                                                <?php if($has_absent){?>
                                                                    <span class="label label-warning">Absent</span>
                                                                <?php } elseif(!$finalresultstatus){?>
                                                                    <span class="label label-danger"><?php echo $this->lang->line('fail');?></span>
                                                                <?php }else{?>
                                                                    <span class="label label-success" ><?php echo $this->lang->line('pass');?></span>
                                                                <?php }?>
