...
<div class="content-wrapper staff-profile-page">
    <div class="row">
        <div class="col-md-12">
...
foreach ($stafflist as $skey => $svalue) {
    ...
    <section class="content">
        <div class="row staff-profile-layout">
            <div class="col-md-12">
                        ...
                        <div class="staff-header-top">
                                ...
                                <div class="staff-header-main">
                                    ...
                                    <div class="staff-header-meta">
                                        <div class="staff-header-meta-item">
                                            <span class="label-text"><?php echo $this->lang->line('staff_id'); ?></span>
                                            <span class="value-text"><?php echo $staff['employee_id']; ?></span>
                                        </div>
                                    </div>
                                    <div class="staff-header-badges">
                                        <span class="staff-role-badge"><?php echo $staff['user_type']; ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="staff-header-actions">
                                        ...
                                        if ($staff["is_active"] == 1) {
                                            if ($this->rbac->hasPrivilege('disable_staff', 'can_view')) {
                                                if ($logged_in_User_Role->id == 7) {
                                                    if ($a) {
                                ?>
                                                        <a class="staff-action-btn text-red" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('disable'); ?>" onclick="disable_staff('<?php echo $id; ?>');"><i class="fa fa-thumbs-o-down"></i></a>
                                <?php                   }
                                                } else { ?>
                                                        <a href="<?php echo base_url('admin/staff/disablestaff/' . $id); ?>" class="staff-action-btn text-red" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('disable'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_disable_this_record'); ?>')"><i class="fa fa-thumbs-o-down"></i></a>
                                <?php               }
                                            }
                                            ...
                                            if ($logged_in_User_Role->id == 7) {
                                                if ($a) {
                                ?>
                                                    <a href="<?php echo base_url('admin/staff/delete/' . $id); ?>" class="staff-action-btn text-red" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_want_to_delete'); ?>');"><i class="fa fa-trash"></i></a>
                                                    <a href="<?php echo base_url('admin/staff/enablestaff/' . $id); ?>" class="staff-action-btn text-green" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('enable'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_you_want_to_enable_this_record'); ?>');"><i class="fa fa-thumbs-o-up"></i></a>
                                <?php               }
                                            } else {
                                ...
                                <?php               }
                                    ...
                                    if ($a) {
                                ?>
                                        <a href="#" class="staff-action-btn change_password text-green" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('change_password'); ?>"><i class="fa fa-key"></i></a>
                                <?php
                                    }
                                    ...
                                    if ($this->rbac->hasPrivilege('staff', 'can_edit')) {
                                        if ($logged_in_User_Role->id == 7) {
                                            if ($a) {
                                ?>
                                                <a href="<?php echo base_url('admin/staff/edit/' . $id); ?>" class="staff-action-btn text-light" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
                                <?php           }
                                        } else {
                                ?>
                                                <a href="<?php echo base_url('admin/staff/edit/' . $id); ?>" class="staff-action-btn text-light" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
...
if (!empty($staff["date_of_joining"]) && $staff["date_of_joining"] != '0000-00-00') {
    ...
    ?></a>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow staff-profile-tabs">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="activity">
                            <div class="profile-section">
                                <h3 class="profile-section-title"><?php echo $this->lang->line('personal_details') ? $this->lang->line('personal_details') : 'Personal Details'; ?></h3>
                                <div class="profile-card-grid">
                                    <div class="profile-card">
                                        <h4 class="profile-card-title"><?php echo $this->lang->line('contact_information') ? $this->lang->line('contact_information') : 'Contact Information'; ?></h4>
                                        <ul class="profile-card-list">
                                            <?php if ($sch_setting->staff_phone) {?>
                                            <li>
                                                <i class="fa fa-phone"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('phone'); ?>:</span> <?php echo $staff['contact_no']; ?></span>
                                            </li>
                                            <?php }if ($sch_setting->staff_emergency_contact) {?>
                                            <li>
                                                <i class="fa fa-user-md"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('emergency_contact_number'); ?>:</span> <?php echo $staff['emergency_contact_no']; ?></span>
                                            </li>
                                            <?php }?>
                                            <li>
                                                <i class="fa fa-envelope"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('email'); ?>:</span> <?php echo $staff['email']; ?></span>
                                            </li>
                                        </ul>
                                    </div>

                                    <div class="profile-card">
                                        <h4 class="profile-card-title"><?php echo $this->lang->line('basic_information') ? $this->lang->line('basic_information') : 'Basic Information'; ?></h4>
                                        <ul class="profile-card-list">
                                            <li>
                                                <i class="fa fa-calendar"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('date_of_birth'); ?>:</span>
                                                    <?php
                                            ...
                                            <li>
                                                ...
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('gender'); ?>:</span> <?php echo $this->lang->line(strtolower($staff['gender'])); ?></span>
                                            </li>
                                            <?php if ($sch_setting->staff_marital_status) {?>
                                            <li>
                                                <i class="fa fa-heart"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('marital_status'); ?>:</span> <?php echo $staff['marital_status']; ?></span>
                                            </li>
                                            <?php }?>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="profile-card">
                                        <h4 class="profile-card-title"><?php echo $this->lang->line('family_details') ? $this->lang->line('family_details') : 'Family Details'; ?></h4>
                                        <ul class="profile-card-list">
                                            <?php if ($sch_setting->staff_father_name) {?>
                                            <li>
                                                <i class="fa fa-user"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('father_name'); ?>:</span> <?php echo $staff['father_name']; ?></span>
                                            </li>
                                            <?php }if ($sch_setting->staff_mother_name) {?>
                                            <li>
                                                <i class="fa fa-user"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('mother_name'); ?>:</span> <?php echo $staff['mother_name']; ?></span>
                                            </li>
                                            <?php }?>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="profile-card">
                                        <h4 class="profile-card-title"><?php echo $this->lang->line('professional_background') ? $this->lang->line('professional_background') : 'Professional Background'; ?></h4>
                                        <ul class="profile-card-list">
                                            <?php if ($sch_setting->staff_qualification) {?>
                                            <li>
                                                <i class="fa fa-graduation-cap"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('qualification'); ?>:</span> <?php echo $staff['qualification']; ?></span>
                                            </li>
                                            <?php }if ($sch_setting->staff_work_experience) {?>
                                            <li>
                                                <i class="fa fa-briefcase"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('work_experience'); ?>:</span> <?php echo $staff['work_exp']; ?></span>
                                            </li>
                                            <?php }if ($sch_setting->staff_note) {?>
                                            <li>
                                                <i class="fa fa-sticky-note"></i>
                                                <span><span class="profile-card-label"><?php echo $this->lang->line('note'); ?>:</span> <?php echo $staff['note']; ?></span>
                                            </li>
                                            <?php }?>
                                        </ul>
                                    </div>
                                ...
                                <div class="profile-card profile-card-full">
                                    ...
                                    <div class="profile-two-column">
                                        ...
                                        <div class="profile-two-column-item">
                                            ...
                                            <span><?php echo $staff['local_address']; ?></span>
                                        </div>
                                        ...
                                        <div class="profile-two-column-item">
                                            ...
                                            <span><?php echo $staff['permanent_address']; ?></span>
                                        </div>
                                        <?php }?>
                                    </div>
                                </div>
                            ...
                            <div class="profile-section">
                                <div class="profile-card profile-card-full">
                                    <h4 class="profile-card-title"><?php echo $this->lang->line('bank_account_details'); ?></h4>
                                    <div class="profile-two-column">
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-user"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('account_title'); ?>:</span>
                                            <span><?php echo $staff['account_title']; ?></span>
                                        </div>
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-university"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('bank_name'); ?>:</span>
                                            <span><?php echo $staff['bank_name']; ?></span>
                                        </div>
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-building"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('bank_branch_name'); ?>:</span>
                                            <span><?php echo $staff['bank_branch']; ?></span>
                                        </div>
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-credit-card"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('bank_account_number'); ?>:</span>
                                            <span><?php echo $staff['bank_account_no']; ?></span>
                                        </div>
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-hashtag"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('ifsc_code'); ?>:</span>
                                            <span><?php echo $staff['ifsc_code']; ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="profile-section">
                                <div class="profile-card profile-card-full">
                                    <h4 class="profile-card-title"><?php echo $this->lang->line('social_media_link'); ?></h4>
                                    <div class="profile-two-column">
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-facebook-square"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('facebook_url'); ?>:</span>
                                            <span><a href="<?php echo $staff['facebook']; ?>" target="_blank"><?php echo $staff['facebook']; ?></a></span>
                                        </div>
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-twitter"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('twitter_url'); ?>:</span>
                                            <span><a href="<?php echo $staff['twitter']; ?>" target="_blank"><?php echo $staff['twitter']; ?></a></span>
                                        </div>
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-linkedin-square"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('linkedin_url'); ?>:</span>
                                            <span><a href="<?php echo $staff['linkedin']; ?>" target="_blank"><?php echo $staff['linkedin']; ?></a></span>
                                        </div>
                                        <div class="profile-two-column-item">
                                            <i class="fa fa-instagram"></i>
                                            <span class="profile-card-label"><?php echo $this->lang->line('instagram_url'); ?>:</span>
                                            <span><a href="<?php echo $staff['instagram']; ?>" target="_blank"><?php echo $staff['instagram']; ?></a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
