                ...
                <ul class="reportlists">
                    ...
                    if ($this->customlib->is_biometricAttendence()) {
                        ...
                        if ($this->rbac->hasPrivilege('biometric_checkin_report', 'can_view')) {
                            ?>
                            <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/biometric_checkin_report'); ?>"><a href="<?php echo site_url('biometric_checkin_report'); ?>"><i class="fa fa-clock-o"></i> Biometric Check-in Report</a></li>
                            <?php
                        }
                    } ?>
