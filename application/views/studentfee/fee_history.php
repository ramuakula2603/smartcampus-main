                            ...
                            <div class="btn-group">
                                <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                    <button class="btn btn-xs btn-warning" 
                                        onclick="revertFeePayment('<?php echo $history->student_fees_deposite_id; ?>', '<?php echo $history->inv_no; ?>')"
                                        title="<?php echo $this->lang->line('revert'); ?>">
                                        <i class="fa fa-undo"></i>
                                    </button>
                                <?php } ?>
                                <button class="btn btn-xs btn-default printFeeReceipt"
...
<script>
function revertFeePayment(mainInvoice, subInvoice) {
...
$(document).on('click', '.printFeeReceipt', function() {
