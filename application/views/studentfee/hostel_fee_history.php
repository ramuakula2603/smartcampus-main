...
<div class="table-responsive">
    <?php if (!empty($hostel_fee_history)) { ?>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php foreach ($hostel_fee_history as $history) { ?>
                    <tr>
                            ...
                            <div class="btn-group">
                                <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                    <button class="btn btn-xs btn-warning" 
                                        onclick="revertHostelFeePayment('<?php echo $history->student_fees_deposite_id; ?>', '<?php echo $history->inv_no; ?>')"
                                        title="<?php echo $this->lang->line('revert'); ?>">
                                        <i class="fa fa-undo"></i>
                                    </button>
                                <?php } ?>
                                <button class="btn btn-xs btn-default printHostelFeeReceipt"
...
<script>
function revertHostelFeePayment(mainInvoice, subInvoice) {
...
$(document).on('click', '.printHostelFeeReceipt', function() {
