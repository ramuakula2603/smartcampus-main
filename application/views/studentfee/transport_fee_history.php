...
<div class="table-responsive">
    <?php if (!empty($transport_fee_history)) { ?>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php foreach ($transport_fee_history as $history) { ?>
                    <tr>
                            ...
                            <div class="btn-group">
                                <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { ?>
                                    <button class="btn btn-xs btn-warning" 
                                        onclick="revertTransportFeePayment('<?php echo $history->student_fees_deposite_id; ?>', '<?php echo $history->inv_no; ?>')"
                                        title="<?php echo $this->lang->line('revert'); ?>">
                                        <i class="fa fa-undo"></i>
                                    </button>
                                <?php } ?>
                                <button class="btn btn-xs btn-default printTransportFeeReceipt"
...
<script>
function revertTransportFeePayment(mainInvoice, subInvoice) {
...
$(document).on('click', '.printTransportFeeReceipt', function() {
