$(document).ready(function () {
        ...
        var table = $('.example').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'colvis',
                    text: '<i class="ri-layout-column-line"></i>',
                    titleAttr: 'Columns',
                    title: $('.download_label').html(),
        ...
        // Safely access DataTables page info when available (prevents JS errors
        // on pages without an .example table). This intentionally does nothing
        // when no table is present.
        var info = null;
        try {
            if (table && typeof table.page === 'function') {
                info = table.page().info ? table.page().info() : table.page.info();
            }
        } catch (e) {
            // Swallow page.info errors to avoid breaking other scripts
        }
