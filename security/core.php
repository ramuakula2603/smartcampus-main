...
<head>
	...
	<meta name="generator" content="CyberDetox Security" />
    <meta name="robots" content="noindex, nofollow">
	<meta name="theme-color" content="#000000">
    <link rel="shortcut icon" href="assets/img/favicon.png">
    <title>CyberDetox Security &rsaquo; Admin Panel</title>
...
?>" class="nav-link" target="_blank" data-toggle="tooltip" title="Visit Site" data-toggle="tooltip" data-placement="bottom">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<center><a href="dashboard.php" class="brand-link">
      <span class="brand-text font-weight-light"><i class="fa fa-unlock-alt"></i> CyberDetox Security</span>
    </a></center>
...
<footer class="main-footer">
    ...
    <strong>&copy; <?php
    echo date("Y");
?> <a href="https://cyberdetox.in" target="_blank">Security Suite by CyberDetox</a> v<?php echo $psec_version; ?></strong>
